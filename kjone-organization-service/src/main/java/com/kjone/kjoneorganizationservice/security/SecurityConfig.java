package com.kjone.kjoneorganizationservice.security;

import com.kjone.kjoneorganizationservice.security.cookie.CookieProvider;
import com.kjone.kjoneorganizationservice.security.jwt.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests((authorize) -> authorize
                        ...
                        .requestMatchers(HttpMethod.POST, "/v1/organization/{name}").hasAnyRole("OWNER", "ADMIN", "EMPLOYEE") //조직 조회 권한
