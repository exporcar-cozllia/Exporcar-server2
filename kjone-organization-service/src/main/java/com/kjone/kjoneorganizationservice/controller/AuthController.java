...
import com.kjone.kjoneorganizationservice.domain.role.Authority;
import com.kjone.kjoneorganizationservice.security.cookie.CookieProvider;
import com.kjone.kjoneorganizationservice.security.jwt.JwtProvider;
import com.kjone.kjoneorganizationservice.service.OrganizationUserService;
...
public class AuthController {
    ...
    public ResponseEntity<?> Organization_signIn(@RequestBody LoginRequest loginRequest, HttpServletResponse response) {
        try {
            // 사용자 인증
            SignResponse organizationResponse = organizationUserService.Organization_signIn(loginRequest);
    ...
    public ResponseEntity<String> deleteUser(@RequestParam String email) {
        try {
            organizationUserService.deleteOrgByEmail(email);
    ...
    public ResponseEntity<List<Organization_User>> getAllUsers() {
        List<Organization_User> organizationUsers = organizationUserService.getAllUsers();
